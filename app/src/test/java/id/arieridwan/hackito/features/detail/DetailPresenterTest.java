...
public class DetailPresenterTest {
    ...
    public void setUp() throws Exception {
        ...
        presenter = new DetailPresenter(apiServices, view);
    }

    @Test
    public void testDisplayDataComments() throws Exception {
        ...
        presenter.loadComments(integers);
        // verify user interaction
        verify(view, times(1)).startLoading();
        verify(view, times(1)).getItemComments(itemCommentsList);
